<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DailyCollectionReciptWise.aspx.cs" Inherits="Reports_DailyCollectionReciptWise" %>
    ...
    <div >
      <div style="width:100%">
       ...
       <Columns> 
          ...
          <asp:BoundField DataField="PreviousBalance" HeaderText="Prev. Bal."  ItemStyle-CssClass="right" DataFormatString="{0:0}"/>
          ...
          <asp:BoundField DataField="CourseFeesRec" HeaderText="T. Paid." ItemStyle-CssClass="right" DataFormatString="{0:0}" />
          <asp:BoundField DataField="CourseFeesBla" HeaderText="T. Bal." ItemStyle-CssClass="right" DataFormatString="{0:0}" />
          <asp:BoundField DataField="TransportFees" HeaderText="Tran. Fee Coll." ItemStyle-CssClass="right" DataFormatString="{0:0}" />
          <asp:BoundField DataField="TransportFeesRec" HeaderText="T. Paid." ItemStyle-CssClass="right" DataFormatString="{0:0}" />
          <asp:BoundField DataField="TransportBalance" HeaderText="T. Bal." ItemStyle-CssClass="right" DataFormatString="{0:0}" />
          ...
          <asp:BoundField DataField="TotalDue" HeaderText="OverAll T.Bal" ItemStyle-CssClass="right" DataFormatString="{0:0}" />
